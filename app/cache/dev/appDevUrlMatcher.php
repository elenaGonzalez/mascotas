    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/mascotas')) {
            if (0 === strpos($pathinfo, '/mascotas/comentario')) {
                ...
                // comentario_create
                if ($pathinfo === '/mascotas/comentario/') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_comentario_create;
                    }

                    return array (  '_controller' => 'Mascotas\\MascotasBundle\\Controller\\ComentarioController::createAction',  '_route' => 'comentario_create',);
                }
                ...
                if ($pathinfo === '/mascotas/comentario/new') {
                    ...
                    return array (  '_controller' => 'Mascotas\\MascotasBundle\\Controller\\ComentarioController::newAction',  '_route' => 'comentario_new',);
                }
                not_comentario_new:
            ...
            if (0 === strpos($pathinfo, '/mascotas/publicacion')) {
                // _publicacion
                if ($pathinfo === '/mascotas/publicacion') {
                    return array (  '_PublicacionController' => 'MascotasMascotasBundle:publicacion',  '_route' => '_publicacion',);
                }
        ...
        // _mascotaNew
        if ($pathinfo === '/mascotas/mascota/new') {
            return array (  '_MascotaController' => 'MascotasMascotasBundle:mascota:new',  '_route' => '_mascotaNew',);
        }
