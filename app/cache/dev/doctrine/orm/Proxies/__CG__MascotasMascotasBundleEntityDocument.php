 ...
 */
class Document extends \Mascotas\MascotasBundle\Entity\Document implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'temp', 'id', 'file', 'name', 'path');
        }
