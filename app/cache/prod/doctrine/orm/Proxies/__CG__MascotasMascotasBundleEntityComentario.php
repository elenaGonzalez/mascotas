 ...
 */
class Comentario extends \Mascotas\MascotasBundle\Entity\Comentario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'publicacion', 'usuario', 'comentario', 'fecha');
        }
